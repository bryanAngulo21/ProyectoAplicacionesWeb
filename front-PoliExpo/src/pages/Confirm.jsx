    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <div className="flex flex-col items-center justify-center">
                <p className="text-3xl md:text-4xl lg:text-5xl text-gray-800 mt-12">Correo confirmado </p>
                <p className="md:text-lg lg:text-xl text-gray-600 mt-8">Ya puedes usar PoliExpo</p>
