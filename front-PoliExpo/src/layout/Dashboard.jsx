    ...
    return (
        ...
        <div className='md:flex md:min-h-screen'>
            ...
            <div className='md:w-1/5 bg-gray-800 px-5 py-4'>
                ...
                <h2 className='text-4xl font-black text-center text-slate-200'>PoliExpo</h2>

                <img src="https://cdn-icons-png.flaticon.com/128/1688/1688400.png" alt="img-client" className="m-auto mt-8 
            ...
            <div className='flex-1 flex flex-col justify-between h-screen bg-gray-100'>
               ...
               {/* Menú de navegación superior */}
                <div className='bg-gray-800 py-2 flex md:justify-end items-center gap-5 justify-center'>
                    ...
                    <div>
                        <img src="https://cdn-icons-png.flaticon.com/128/863/863823.png" alt="img-client" className="border-2 border-green-600 rounded-full" width={50} height={50} />
                    </div>
